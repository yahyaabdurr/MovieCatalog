...
import 'package:ditonton/domain/usecases/get_tv_watchlist_movies.dart' as _i7;
...
/// A class which mocks [GetWatchlistTvMovies].
///
/// See the documentation for Mockito's code generation for more information.
class MockGetWatchlistTvMovies extends _i1.Mock
    implements _i7.GetWatchlistTvMovies {
  MockGetWatchlistTvMovies() {
    _i1.throwOnMissingStub(this);
  }
  ...
  _i4.Future<_i2.Either<_i5.Failure, List<_i8.TvSeries>>> execute() =>
      (super.noSuchMethod(Invocation.method(#execute, []),
              returnValue:
                  Future<_i2.Either<_i5.Failure, List<_i8.TvSeries>>>.value(
