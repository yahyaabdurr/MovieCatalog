...
@GenerateMocks([GetWatchlistMovies, GetWatchlistTvMovies])
void main() {
  late WatchlistMovieNotifier provider;
  late MockGetWatchlistMovies mockGetWatchlistMovies;
  late MockGetWatchlistTvMovies mockGetWatchlistTvMovies;
  late int listenerCallCount;

  setUp(() {
    listenerCallCount = 0;
    mockGetWatchlistTvMovies = MockGetWatchlistTvMovies();
    mockGetWatchlistMovies = MockGetWatchlistMovies();
    provider = WatchlistMovieNotifier(
      getWatchlistMovies: mockGetWatchlistMovies,
      getWatchlistTvMovies: mockGetWatchlistTvMovies,
    )..addListener(() {
        listenerCallCount += 1;
      });
  });
